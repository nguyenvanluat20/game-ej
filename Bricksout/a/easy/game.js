 ...
 const PADDLE_SPD = 1.05;
 const PADDLE_W = 0.1;
 const PUP_BONUS = 50;
 const PUP_CHANCE = 0.3;
 const PUP_SPD = 0.15;
 const WALL = 0.02;
 ...
 const TEXT_SCORE_HIGH = "HI-SCORE";
 ...
 var fxBrick = new Audio("sounds/brick_hit.mp3");
 var fxPaddle = new Audio("sounds/paddle_hit.mp3");
 var fxPowerup = new Audio("sounds/levelup.mp3");
 var fxWall = new Audio("sounds/wall.mp3");
 ...
 function loop(timeNow) {
     ...
     if (gameOver) {
         ...
         view.setActiveScreen('gameoverState')
